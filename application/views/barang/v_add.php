<div class="col-md-12">
	...
	<div class="card card-primary">
		<div class="card-header">
			<h3 class="card-title">Form Add Ban</h3>
		</div>
		<!-- /.card-header -->
		<div class="card-body">
			<?php
			...
			<div class="form-group">
				...
				<input name="nama_barang" class="form-control" placeholder="Nama Ban" value="<?= set_value('nama_barang') ?>">
			</div>
			<div class="row">
				<div class="col-sm-4">
					<div class="form-group">
				...
				<div class="col-sm-4">
					<div class="form-group">
						<label>Harga</label>
						<input name="harga" class="form-control" placeholder="Harga Ban (200000)" value="<?= set_value('harga') ?>">
					</div>
				</div>
				<div class="col-sm-4">
					<div class="form-group">
						<label>Stock</label>
						<input type="number" name="stock" min="0" class="form-control" placeholder="Stock" value="<?= set_value('stock') ?>">
					</div>
				</div>
			</div>

			<div class="form-group">
				<label>Deskripsi Ban</label>
